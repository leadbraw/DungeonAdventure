...
class GameController:
    ...
    def end_message(self):
        ...
        monster_rect = pygame.Rect(530, 30, 35, 35)
        elite_rect = pygame.Rect(530, 80, 35, 35)
        item_rect = pygame.Rect(530, 130, 35, 35)
        trap_rect = pygame.Rect(530, 180, 35, 35)
        pillar_rect = pygame.Rect(530, 230, 35, 35)
        empty_rect = pygame.Rect(530, 280, 35, 35)
        entrance_rect = pygame.Rect(530, 330, 35, 35)
        exit_rect = pygame.Rect(530, 380, 35, 35)
        ...
        while end_running:
            ...
            if position == 0:
                ...
                self.screen.blit(monster_text, (580, 30 + elite_text.get_height() / 2 - 3))
                self.screen.blit(elite_text, (580, 80 + elite_text.get_height() / 2 - 3))
                self.screen.blit(item_text, (580, 130 + elite_text.get_height() / 2 - 3))
                self.screen.blit(trap_text, (580, 180 + elite_text.get_height() / 2 - 3))
                self.screen.blit(pillar_text, (580, 230 + elite_text.get_height() / 2 - 3))
                self.screen.blit(empty_text, (580, 280 + elite_text.get_height() / 2 - 3))
                self.screen.blit(entrance_text, (580, 330 + elite_text.get_height() / 2 - 3))
                self.screen.blit(exit_text, (580, 380 + elite_text.get_height() / 2 - 3))
                map_surface = pygame.transform.scale(self.full_maps[position - 1], (400, 400))
                self.screen.blit(map_surface, (120, 25))
